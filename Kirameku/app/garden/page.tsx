...
// 图表行（recharts，约 300KB）按需加载，不进 garden 首页首屏
const Charts = dynamic(() => import("./Charts"), {
  ssr: false,
  loading: () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <div className="lg:col-span-2 bg-white/70 dark:bg-slate-800/50 rounded-xl p-4 md:p-5 border border-slate-200/50 dark:border-white/5 h-64 animate-pulse" />
      <div className="bg-white/70 dark:bg-slate-800/50 rounded-xl p-4 md:p-5 border border-slate-200/50 dark:border-white/5 h-64 animate-pulse" />
    </div>
  ),
});
