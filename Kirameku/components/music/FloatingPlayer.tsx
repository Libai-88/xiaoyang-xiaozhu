  ...
  return (
    ...
    >
      {expanded ? (
        ...
        <div className="relative">
          <div className="flex items-center gap-1.5 h-12 pl-1 pr-1.5 rounded-full bg-white/80 dark:bg-slate-900/90 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-2xl select-none">
            ...
            <div className="w-8 h-8 rounded-full overflow-hidden shrink-0 shadow-sm cursor-grab active:cursor-grabbing">
              <img src={currentSong.cover} alt="" loading="lazy" decoding="async" onError={musicCoverFallback} className="w-full h-full object-cover pointer-events-none" draggable={false} />
            </div>
              ...
              {playlist.map((song, i) => (
                ...
                >
                  <div className="w-7 h-7 rounded overflow-hidden shrink-0">
                    <img src={song.cover} alt="" loading="lazy" decoding="async" onError={musicCoverFallback} className="w-full h-full object-cover" />
                  </div>
        ...
        >
          <img src={currentSong.cover} alt="" loading="lazy" decoding="async" onError={musicCoverFallback} className="w-full h-full object-cover rounded-full pointer-events-none" draggable={false} />
          {isPlaying && (
